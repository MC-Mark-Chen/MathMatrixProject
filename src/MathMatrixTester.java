...
/* Put your experiment results and answers to questions here. */
...
public class MathMatrixTester {
    ...
    public static void main(String[] args) {
        ...
        data1 = new int[][] {{10, 100, 101, -1000},
            ...
            // test 11 - 14, multiply stress test (possible to get Answer by Accident)
    ...
    // precondition: rows > 0, cols > 0, randNumGen != null
    ...
    // precondition: m != null, m is at least 1 by 1 in size
    ...
    // precondition: data1 != null, data2 != null, data1 and data2 are at least 1 by 1 matrices
    //      data1 and data2 are rectangular matrices
    // postcondition: return true if data1 and data2 are the same size and all elements are
    //      the same
    ...
    // precondition: mat != null, mat is at least 1 by 1
